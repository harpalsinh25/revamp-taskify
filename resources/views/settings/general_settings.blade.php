...
<div class="container-fluid">
    ...
    <form action="{{url('settings/store_general')}}" class="form-submit-event" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 col-md-12">
                    ...
                    <div class="card-body pt-4">
                        <div class="row">
                            <div class="mb-3 col-md-6 tk-field">
                                <label for="company_title" class="tk-label"><?= get_label('company_title', 'Company Title') ?> <span class="asterisk">*</span></label>
                                <input class="tk-input" type="text" id="company_title" name="company_title" placeholder="<?= get_label('please_enter_company_title', 'Please enter company title') ?>" value="{{ $general_settings['company_title'] }}">
                            </div>
                            <div class="mb-3 col-md-6 tk-field">
                                <label for="site_url" class="tk-label">
                                ...
                                <input class="tk-input" type="text" id="site_url" name="site_url" placeholder="<?= get_label('please_enter_site_url', 'Please enter site URL') ?>" value="{{ $general_settings['site_url'] }}">
                            </div>

                            <div class="mb-3 col-md-4 tk-field">
                                <label for="full_logo" class="tk-label"><?= get_label('full_logo', 'Full Logo') ?> <a data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="<?= get_label('view_current_full_logo', 'View current full logo') ?>" href="{{asset($general_settings['full_logo'])}}" data-lightbox="full_logo" data-title="<?= get_label('current_full_logo', 'Current full logo') ?>"> <i class='bx bx-show-alt text-primary'></i></a></label>
                                <input type="file" class="tk-file-input" id="full_logo" name="full_logo">
                            </div>
                            <div class="mb-3 col-md-4 tk-field">
                                <label for="favicon" class="tk-label"><?= get_label('favicon', 'Favicon') ?> <a data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="<?= get_label('view_current_favicon', 'View current favicon') ?>" href="{{asset($general_settings['favicon'])}}" data-lightbox="favicon" data-title="<?= get_label('current_favicon', 'Current favicon') ?>"> <i class='bx bx-show-alt text-primary'></i></a></label>
                                <input type="file" class="tk-file-input" id="favicon" name="favicon">
                            </div>
                            <div class="mb-3 col-md-4 tk-field">
                                <label for="half_logo" class="tk-label"><?= get_label('half_logo', 'Half Logo') ?> <a data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="<?= get_label('view_current_half_logo', 'View current half logo') ?>" href="{{asset($general_settings['half_logo'])}}" data-lightbox="half_logo" data-title="<?= get_label('current_half_logo', 'Current half logo') ?>"> <i class='bx bx-show-alt text-primary'></i></a></label>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body pt-4">
                        <div class="row">
                            <div class="mb-3 col-md-6 tk-field">
                                <label class="tk-label" for="timezone"><?= get_label('system_time_zone', 'System Time Zone') ?> <span class="asterisk">*</span></label>
                                <select class="tk-select select2" id="timezone" name="timezone" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>">
                            ...
                            <div class="mb-3 col-md-6 tk-field">
                                <label class="tk-label" for="date_format"><?= get_label('date_format', 'Date Format') ?> <span class="asterisk">*</span></label>
                                <select class="tk-select select2" id="date_format" name="date_format" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>">
                            ...
                            <div class="mb-3 col-md-6 tk-field">
                                <label for="time_format" class="tk-label"><?= get_label('time_format', 'Time Format') ?></label>
                                <select class="tk-select" name="time_format" id="time_format">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body pt-4">
                        <div class="row">
                            <div class="mb-3 col-md-4 tk-field">
                                <label for="total_paid_leaves_per_year" class="tk-label">{{ get_label('total_paid_leaves_per_year', 'Total Paid Leaves / Year') }} <span class="asterisk">*</span></label>
                                ...
                                <input class="tk-input" type="number" id="total_paid_leaves_per_year" name="total_paid_leaves_per_year" placeholder="12" value="{{ $general_settings['total_paid_leaves_per_year'] ?? 15 }}" min="0" step="0.5">
                            </div>

                            <div class="mb-3 col-md-4 tk-field">
                                <label for="leave_accrual_type" class="tk-label">{{ get_label('leave_accrual_type', 'Leave Accrual Type') }}</label>
                                ...
                                <select class="tk-select" id="leave_accrual_type" name="leave_accrual_type">
                            ...
                            <div class="mb-3 col-md-4 tk-field">
                                <label for="company_year_start" class="tk-label">{{ get_label('company_year_start', 'Company Year Start') }} <span class="asterisk">*</span></label>
                                ...
                                @endphp
                                <input class="tk-input" type="text" id="company_year_start" name="company_year_start" placeholder="01-01" value="{{ $startValue }}" pattern="\d{2}-\d{2}">
                                <small class="text-muted d-block mt-1">Format: MM-DD</small>
                            </div>

                            <div class="mb-3 col-md-4 tk-field">
                                <label for="company_year_end" class="tk-label">{{ get_label('company_year_end', 'Company Year End') }} <span class="asterisk">*</span></label>
                                ...
                                @endphp
                                <input class="tk-input" type="text" id="company_year_end" name="company_year_end" placeholder="12-31" value="{{ $endValue }}" pattern="\d{2}-\d{2}">
                    ...
                    <div class="card-body pt-4">
                        <div class="row">
                            <div class="mb-3 col-md-12 tk-field">
                                <textarea id="footer_text" name="footer_text" class="tk-input"><?= $general_settings['footer_text'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body pt-4">
                        <div class="row">
                            <div class="mb-3 col-md-12 tk-field">
                                <label for="currency_full_form" class="tk-label"><?= get_label('currency_full_form', 'Currency Full Form') ?> <span class="asterisk">*</span></label>
                                <input class="tk-input" type="text" id="currency_full_form" name="currency_full_form" placeholder="<?= get_label('please_enter_currency_full_form', 'Please enter currency full form') ?>" value="{{$general_settings['currency_full_form']}}">
                            </div>
                            <div class="mb-3 col-md-12 tk-field">
                                <label for="currency_symbol" class="tk-label"><?= get_label('currency_symbol', 'Currency Symbol') ?> <span class="asterisk">*</span></label>
                                <input class="tk-input" type="text" id="currency_symbol" name="currency_symbol" placeholder="<?= get_label('please_enter_currency_symbol', 'Please enter currency symbol') ?>" value="{{$general_settings['currency_symbol']}}">
                            </div>
                            <div class="mb-3 col-md-12 tk-field">
                                <label for="currency_code" class="tk-label"><?= get_label('currency_code', 'Currency Code') ?> <span class="asterisk">*</span></label>
                                <input class="tk-input" type="text" id="currency_code" name="currency_code" placeholder="<?= get_label('please_enter_currency_code', 'Please enter currency code') ?>" value="{{$general_settings['currency_code']}}">
                            </div>
                            <div class="mb-3 col-md-12 tk-field">
                                <label for="currency_symbol_position" class="tk-label"><?= get_label('currency_symbol_position', 'Currency Symbol Position') ?></label>
                                <select class="tk-select" name="currency_symbol_position" id="currency_symbol_position">
                            ...
                            <div class="mb-3 col-md-12 tk-field">
                                <label for="currency_formate" class="tk-label"><?= get_label('currency_formate', 'Currency Format') ?></label>
                                <select class="tk-select" name="currency_formate" id="currency_formate">
                            ...
                            <div class="mb-3 col-md-12 tk-field">
                                <label for="decimal_points_in_currency" class="tk-label"><?= get_label('decimal_points_in_currency', 'Decimal Points in Currency') ?></label>
                                <input class="tk-input" type="number" id="decimal_points_in_currency" name="decimal_points_in_currency" step="1" placeholder="e.g. 2 for 100.00" value="{{$general_settings['decimal_points_in_currency']}}" oninput="this.value = Math.floor(this.value)" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body pt-4">
                        <div class="mb-3 tk-field">
                            <label for="primaryColorPicker" class="tk-label"><?= get_label('primary_color', 'Primary Color') ?></label>
                            <div class="d-flex align-items-center gap-3">
                                <input type="color" class="tk-input form-control-color" name="primary_color" id="primaryColorPicker" title="<?= get_label('choose_your_color', 'Choose your color') ?>" value="{{ $general_settings['primary_color'] ?? '#696cff' }}">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body pt-4">
                        <div class="mb-4 tk-field">
                            <label for="toastPosition" class="tk-label mb-2 d-block">
                            ...
                            <select id="toastPosition" class="tk-select" name="toast_position">
                        ...
                        <div class="mb-4 tk-field">
                            <label for="toastTimeout" class="tk-label mb-2 d-block">
                            ...
                            <input id="toastTimeout" class="tk-input" type="number" name="toast_time_out" step="0.1" placeholder="5" value="{{$general_settings['toast_time_out']}}" min="0.1">
                        </div>
                        <div class="mb-3">
                            <button id="previewToast" class="tk-btn tk-btn-outline w-100" type="button"><i class='bx bx-show me-1'></i> {{get_label('preview_toast','Preview Toast')}}</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 mt-4 mb-5 text-start">
                <button type="submit" class="tk-btn tk-btn-primary me-2" id="submit_btn"><i class='bx bx-save me-1'></i> <?= get_label('save_changes', 'Save Changes') ?></button>
