    ...
    <div class="card-body py-3">
        <div class="row g-3 align-items-end">
            <div class="col-md-3 tk-field">
                ...
                <input type="text" class="tk-input" id="candidate_date_between"
            ...
            <div class="col-md-3 tk-field">
                ...
                <select class="tk-select tom_static_select" id="sort" name="sort"
            ...
            <div class="col-md-3 tk-field">
                ...
                <select class="tk-select tom_candidate_statuses_select" id="select_candidate_statuses" name="statuses[]" aria-label="Default select example"
                    data-placeholder="<?= get_label('filter_by_statuses', 'Filter by statuses') ?>" data-allow-clear="true"
                    multiple>
                </select>
            </div>
            <div class="col-md-3 d-flex align-items-end">
                <button type="button" id="filter" class="tk-btn tk-btn-primary" data-bs-toggle="tooltip"
