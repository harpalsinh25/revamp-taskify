...
<div id="dashboard-items" class="row">
    @if ($auth_user->can('manage_projects'))
        <div class="col-md-4 col-sm-12 draggable-item" id="project-statistics" data-id="project-statistics">
    ...
    @if ($auth_user->can('manage_tasks'))
        <div class="col-md-4 col-sm-12 draggable-item" id="task-statistics" data-id="task-statistics">
    ...
    @endif
    <div class="col-md-4 col-sm-12 draggable-item" id="todos-overview" data-id="todos-overview">
    ...
    @if ($auth_user->hasRole('admin'))
        ...
        <div class="col-md-6 draggable-item" id="recent-activities" data-id="recent-activities">
            @php
