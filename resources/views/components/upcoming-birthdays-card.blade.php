...
<div class="d-flex flex-wrap gap-3 mb-3 tk-filter-bar">
    <div class="flex-grow-1" style="min-width: 250px; max-width: 300px;">
        <select class="form-select tom_users_select" id="birthday_user_filter" aria-label="Default select example" data-placeholder="<?= get_label('select_members', 'Select Members') ?>" multiple>
        </select>
    </div>
    <div class="flex-grow-1" style="min-width: 250px; max-width: 300px;">
        <select class="form-select tom_clients_select" id="birthday_client_filter" aria-label="Default select example" data-placeholder="<?= get_label('select_clients', 'Select Clients') ?>" multiple>
        </select>
    </div>
    <div class="flex-grow-1" style="min-width: 250px; max-width: 300px;">
