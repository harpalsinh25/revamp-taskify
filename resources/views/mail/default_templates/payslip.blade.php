...
<p style="box-sizing: border-box; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Emoji','Segoe UI Symbol'; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Please find your payslip attached for <strong>{MONTH_YEAR}</strong>.<br><br>Your payslip details for <strong>{PAYSLIP_ID}</strong> are included in the attached PDF document.</p>
<p style="box-sizing: border-box; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">If you have any questions or concerns regarding your payslip, please feel free to contact us.</p>
...
<p style="box-sizing: border-box; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 14px;"><strong>{COMPANY_TITLE}</strong></p>
</td>
</tr>
</tbody>
</table>
