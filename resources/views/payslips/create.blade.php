        ...
        <div class="card-body">
            <form action="{{url('payslips/store')}}" class="form-submit-event" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-12">
                        <div id="leave-summary" class="bg-white border rounded-3 p-3">
                            <div class="align-items-center d-flex flex-wrap gap-3 justify-content-between small">
                    ...
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('payslip_month', 'Payslip month') ?> <span class="asterisk">*</span></label>
                        <input class="tk-input" type="month" id="payslip_month" name="month" value="{{ old('payslip_month') }}">
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('basic_salary', 'Basic salary') ?> <span class="asterisk">*</span></label>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{$general_settings['currency_symbol']}}</span>
                            <input class="tk-input" style="border-top-left-radius: 0; border-bottom-left-radius: 0;" type="number" id="basic_salary" name="basic_salary" min="0" placeholder="<?= get_label('please_enter_basic_salary', 'Please enter basic salary') ?>" value="{{ old('basic_salary') }}">
                        </div>
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('working_days', 'Working days') ?> <span class="asterisk">*</span></label>
                        <input class="tk-input" type="number" id="working_days" name="working_days" step="0.5" min="0" max="31" placeholder="<?= get_label('please_enter_working_days', 'Please enter working days') ?>" value="{{ old('working_days') }}">
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('lop_days', 'Loss of pay days') ?> <span class="asterisk">*</span></label>
                        <input class="tk-input" type="number" id="lop_days" name="lop_days" step="0.25" min="0" placeholder="<?= get_label('please_enter_lop_days', 'Please enter loss of pay days') ?>" value="{{ old('lop_days')??0 }}">
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('paid_days', 'Paid days') ?> <span class="asterisk">*</span></label>
                        <input class="tk-input" type="number" id="paid_days" name="paid_days" value="{{ old('paid_days') }}" readonly>
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('bonus', 'Bonus') ?> <span class="asterisk">*</span></label>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{$general_settings['currency_symbol']}}</span>
                            <input class="tk-input" style="border-top-left-radius: 0; border-bottom-left-radius: 0;" type="number" id="bonus" name="bonus" min="0" placeholder="<?= get_label('please_enter_bonus', 'Please enter bonus') ?>" value="{{ old('bonus')??0 }}">
                        </div>
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('incentives', 'Incentives') ?> <span class="asterisk">*</span></label>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{$general_settings['currency_symbol']}}</span>
                            <input class="tk-input" style="border-top-left-radius: 0; border-bottom-left-radius: 0;" type="number" id="incentives" name="incentives" min="0" placeholder="<?= get_label('please_enter_incentives', 'Please enter incentives') ?>" value="{{ old('incentives')??0 }}">
                        </div>
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('leave_deduction', 'Leave deduction') ?> <span class="asterisk">*</span></label>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{$general_settings['currency_symbol']}}</span>
                            <input class="tk-input" style="border-top-left-radius: 0; border-bottom-left-radius: 0;" type="number" id="leave_deduction" name="leave_deduction" value="{{ old('leave_deduction') }}" readonly>
                        </div>
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('over_time_hours', 'Over time hours') ?></label>
                        <input class="tk-input" type="number" step="0.5" id="over_time_hours" min="0" name="ot_hours" placeholder="<?= get_label('please_enter_over_time_hours', 'Please enter over time hours') ?>" value="{{ old('ot_hours')??0 }}">
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('over_time_rate', 'Over time rate') ?> <span class="asterisk">*</span></label>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{$general_settings['currency_symbol']}}</span>
                            <input class="tk-input" style="border-top-left-radius: 0; border-bottom-left-radius: 0;" type="number" id="over_time_rate" min="0" name="ot_rate" placeholder="<?= get_label('please_enter_over_time_rate', 'Please enter over time rate') ?>" value="{{ old('ot_rate')??0 }}">
                        </div>
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('over_time_payment', 'Over time payment') ?> <span class="asterisk">*</span></label>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{$general_settings['currency_symbol']}}</span>
                            <input class="tk-input" style="border-top-left-radius: 0; border-bottom-left-radius: 0;" type="number" id="over_time_payment" name="ot_payment" value="{{ old('ot_payment') }}" readonly>
                        </div>
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('payment_status', 'Payment status') ?> <span class="asterisk">*</span></label>
                        <div class="">
                    ...
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('payment_date', 'Payment date') ?></label>
                        <input type="text" id="payment_date" name="payment_date" class="tk-input" data-defaultDate="false" placeholder="<?= get_label('please_select', 'Please select') ?>" autocomplete="off">
                    </div>
                    <div class="mb-3 col-md-4 tk-field">
                        <label class="tk-label" for=""><?= get_label('payment_method', 'Payment method') ?></label>
                    ...
                    <div class="mb-3 col-md-5 tk-field">
                        <label class="tk-label" for=""><?= get_label('allowance', 'Allowance') ?></label>
                    ...
                    <div class="mb-3 col-md-7 tk-field">
                        <label class="tk-label" for=""><?= get_label('deduction', 'Deduction') ?></label>
                    ...
                    <div class="row">
                        <div class="col-md-5" id="payslip-allowances">
                            <div class="d-flex">
                                <div class="mb-3 col-md-6 mx-1 tk-field">
                                    <label class="tk-label text-muted" for=""><?= get_label('allowance', 'Allowance') ?></label>
                                ...
                                <div class="mb-3 col-md-4 mx-1 tk-field">
                                    <label class="tk-label text-muted" for=""><?= get_label('amount', 'Amount') ?> ({{$general_settings['currency_symbol']}})</label>
                                ...
                                <div class="mb-3 col-md-1 mx-1 tk-field">
                                    <label class="tk-label text-muted" for=""><?= get_label('action', 'Action') ?></label>
                        ...
                        <div class="col-md-7" id="payslip-deductions">
                            <div class="d-flex">
                                <div class="mb-3 col-md-5 mx-1 tk-field">
                                    <label class="tk-label text-muted" for=""><?= get_label('deduction', 'Deduction') ?></label>
                                ...
                                <div class="mb-3 col-md-3 mx-1 tk-field">
                                    <label class="tk-label text-muted" for=""><?= get_label('percentage', 'Percentage') ?></label>
                                    <input type="text" id="deduction_0_percentage" class="tk-input" placeholder="<?= get_label('percentage', 'Percentage') ?>" readonly>
                                </div>
                                <div class="mb-3 col-md-1 mx-1 tk-field">
                                    <label class="tk-label text-muted" for=""><?= get_label('action', 'Action') ?></label>
                        ...
                        <div class="d-flex">
                            <div class="col-md-5 mt-4">
                                <label class="tk-label" for=""><?= get_label('total_allowances', 'Total allowances') ?> ({{$general_settings['currency_symbol']}}) : <span id="total_allowance">0.00</span></label>
                            </div>
                            <div class="col-md-7 mt-4 mx-4">
                                <label class="tk-label" for=""><?= get_label('total_deductions', 'Total deductions') ?> ({{$general_settings['currency_symbol']}}) : <span id="total_deduction">0.00</span></label>
                            </div>
                        </div>
                        <div class="d-flex">
                ...
                <div class="mb-3 col-md-12 mt-4 tk-field">
                    ...
                    <textarea class="tk-input" name="note" rows="3" placeholder="<?= get_label('please_enter_note_if_any', 'Please enter note if any') ?>">{{ old('note') }}</textarea>
                </div>
