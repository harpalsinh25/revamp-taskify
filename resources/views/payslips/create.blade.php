            ...
            <form action="{{url('payslips/store')}}" class="form-submit-event" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="number" id="lop_days" name="lop_days" step="0.25" min="0" placeholder="<?= get_label('please_enter_lop_days', 'Please enter loss of pay days') ?>" value="{{ old('lop_days')??0 }}">
                    </div>
                    <div class="mb-3 col-md-4">
