...
function loadScreenshots(reset = false) {
    ...
    $.get(screenshotDataUrl, {
        ...
        response.data.forEach(item => {
            ...
            const capturedDate = captured.toLocaleDateString();
            const capturedTime = captured.toLocaleTimeString([], {
                hour: '2-digit',
                minute: '2-digit'
            });
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2 gallery-item-wrapper">
        <div class="gallery-item">
            <a href="${item.image_url}" data-lightbox="screenshots" data-title="${item.user_name} | ${capturedDate} ${capturedTime} | ${item.file_size_kb}">
            ...
            <div class="gallery-info">
                ...
                <div class="gallery-meta">
                    <i class="bx bx-time me-1"></i>${capturedDate} ${capturedTime}
                    <br>
