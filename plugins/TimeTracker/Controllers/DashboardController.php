        ...
        foreach ($logs as $log) {
            ...
            switch ($log->action) {
                case 'clock-in':
                    ...
                    break;
                case 'clock-out':
                    if ($clockInTime && $timestamp >= $clockInTime) {
                        $metrics['work_time'] += $clockInTime->diffInMinutes($timestamp);
                    }
                    break;
                case 'break-start':
                    ...
                    break;
                case 'break-stop':
                    if ($breakStartTime && $timestamp >= $breakStartTime) {
                ...
                case 'idle-start':
                    ...
                    break;
                case 'idle-stop':
                    if ($idleStartTime && $timestamp >= $idleStartTime) {
                ...
                case 'manual-start':
                    ...
                    break;
                case 'manual-stop':
                    if ($manualStartTime && $timestamp >= $manualStartTime) {
                ...
                case 'manual-processing-stop':
                    if ($manualProcessingStartTime && $timestamp >= $manualProcessingStartTime) {
