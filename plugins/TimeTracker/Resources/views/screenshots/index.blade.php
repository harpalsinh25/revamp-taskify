        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                <div class="col-md-4">
                    ...
                    <input type="text" id="dateRange" class="form-control cursor-pointer bg-white" readonly>
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-semibold">{{get_label('users','Users')}}</label>
                    <select id="filterUser" class="form-select" multiple>
            ...
            <div class="d-flex mt-3 flex-wrap gap-2">
                <button class="btn btn-sm btn-outline-secondary preset-btn" data-preset="today">{{ get_label('today','Today') }}</button>
                <button class="btn btn-sm btn-outline-secondary preset-btn" data-preset="yesterday">{{ get_label('yesterday','Yesterday') }}</button>
                <button class="btn btn-sm btn-outline-secondary preset-btn" data-preset="thisWeek">{{ get_label('this_week','This Week') }}</button>
                <button class="btn btn-sm btn-outline-secondary preset-btn" data-preset="lastWeek">{{ get_label('last_week','Last Week') }}</button>
                <button class="btn btn-sm btn-outline-secondary preset-btn" data-preset="thisMonth">{{ get_label('this_month','This Month') }}</button>
            </div>
        </div>
    </div>
