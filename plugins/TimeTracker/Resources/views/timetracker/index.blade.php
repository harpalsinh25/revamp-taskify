                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="daterange" class="form-control" readonly
                                           ...
                                           data-bs-placement="bottom" title="Click to open date picker">
                                </div>
                                <div class="form-text">
                                    <i class="bx bx-time-five me-1"></i>
                                    {{ get_label('quick_select','Quick select') }}:
                                    <span class="badge bg-light text-dark ms-1 cursor-pointer quick-date-btn" data-range="today"
                                          data-bs-toggle="tooltip" title="{{ get_label('view_today_data', 'View today data')  }}">{{ get_label('today','Today') }}</span>
                                    <span class="badge bg-light text-dark ms-1 cursor-pointer quick-date-btn" data-range="yesterday"
                                          data-bs-toggle="tooltip" title="{{ get_label('view_yesterday_data','View yesterday data') }}">{{ get_label('yesterday','Yesterday') }}</span>
                                    <span class="badge bg-light text-dark ms-1 cursor-pointer quick-date-btn" data-range="last7days"
                                          data-bs-toggle="tooltip" title="{{ get_label('view_last_7_days_data','View last 7 days data') }}">{{get_label('last_7_days','Last 7 days')}}</span>
                                    <span class="badge bg-light text-dark ms-1 cursor-pointer quick-date-btn" data-range="last30days"
                                          data-bs-toggle="tooltip" title="{{ get_label('view_last_30_days_data','View last 30 days data') }}">{{ get_label('last_30_days','Last 30 days') }}</span>
                                    <span class="badge bg-light text-dark ms-1 cursor-pointer quick-date-btn" data-range="thismonth"
                                          data-bs-toggle="tooltip" title="{{ get_label('view_current_month_data','View current month data') }}">{{ get_label('current_month','Current Month') }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
