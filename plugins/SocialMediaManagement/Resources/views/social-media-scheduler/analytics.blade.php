        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-2 mb-3">
                        <button type="button" class="btn btn-outline-secondary" id="refreshSocialAnalytics">
        ...
        <div id="analyticsContent">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <small
                                        class="text-muted d-block"><?= get_label('published_posts', 'Published Posts') ?></small>
                                    <div class="d-flex align-items-center">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <small
                                        class="text-muted d-block"><?= get_label('scheduled_posts', 'Scheduled Posts') ?></small>
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item trend-period" href="#"
                                            data-period="daily">{{ get_label('daily', 'Daily') }}</a></li>
                                    <li><a class="dropdown-item trend-period" href="#"
                                            data-period="weekly">{{ get_label('weekly', 'Weekly') }}</a></li>
                                    <li><a class="dropdown-item trend-period" href="#"
                                            data-period="monthly">{{ get_label('monthly', 'Monthly') }}</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="card-title mb-0">
                                <?= get_label('post_status_distribution', 'Post Status Distribution') ?></h5>
                        </div>
                        <div class="card-body">
            ...
            <div class="row mb-4">
                ...
                <div class="col-xl-6 col-lg-6 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><?= get_label('platform_performance', 'Platform Performance') ?>
                            </h5>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3 text-center">
                                ...
                                <div class="col-6">
                                    ...
                                    <small
                                        class="text-muted"><?= get_label('avg_media_per_post', 'Avg Media/Post') ?></small>
                                </div>
                                <hr class="mt-2">
                            </div>
                            <!-- Scheduling Chart -->
