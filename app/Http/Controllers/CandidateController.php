...
class CandidateController extends Controller
{
    ...
    public function deleteAttachment($id)
    {
        ...
        return DeletionService::delete(\Spatie\MediaLibrary\MediaCollections\Models\Media::class, $media->id, 'Attachment');
    }
    ...
    public function destroy($id)
    {
        ...
        return DeletionService::delete(Candidate::class, $candidate->id, 'Candidate');
    }
