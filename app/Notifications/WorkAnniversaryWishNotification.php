...
class WorkAnniversaryWishNotification extends Notification
{
    private $data;
    ...
    public function toMail($notifiable)
    {
        ...
        $subjectPlaceholders = [
            ...
            '{WORK_ANNIVERSARY_COUNT}' => $notification_data['work_anniversary_count'],
        ...
        if (filled(Arr::get($fetched_data, 'content'))) {
            ...
            $defaultTemplatePath = resource_path('views/mail/default_templates/work_anniversary_wish.blade.php');
